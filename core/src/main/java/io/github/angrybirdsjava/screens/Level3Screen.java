...
public class Level3Screen implements Screen, InputProcessor {
    ...
    private ArrayList<Body> rectangles_ver=new Structures("wooden_vertical",world, 6, 0, "Level_tmx_files/level-3.tmx").return_array();
    private ArrayList<Body> rectangles_hor=new Structures("wooden_horizontal",world, 6, 0, "Level_tmx_files/level-3.tmx").return_array();;
    private ArrayList<Body> wooden_squares=new Structures("wooden_square",world, 10, 0, "Level_tmx_files/level-3.tmx").return_array();;
    private ArrayList<Body> stone_squares=new Structures("stone_square",world, 1000, 0, "Level_tmx_files/level-3.tmx").return_array();;
    private ArrayList<Body> thick_hor=new Structures("wooden_thick_horizontal",world, 12, 0, "Level_tmx_files/level-3.tmx").return_array();;
    private ArrayList<Body> base_objetcs=new Structures("wooden_base",world, 50, 0, "Level_tmx_files/level-3.tmx").return_array();;
    private ArrayList<Body> glass_verticals=new Structures("glass_vertical",world, 2, 0, "Level_tmx_files/level-3.tmx").return_array();;
    private ArrayList<Body> glass_horizontals=new Structures("glass_horizontal",world, 2, 0, "Level_tmx_files/level-3.tmx").return_array();;
    private ArrayList<Body> soils=new Structures("soil",world, 1000, 0, "Level_tmx_files/level-3.tmx").return_array();;
...
//        batch.draw(sling,57,128,185,90);
        ...
        Vector2 v2 = (Vector2) crown_pig2.getPosition();
        Vector2 v3 = (Vector2) crown_pig3.getPosition();
        float angle = MathUtils.radiansToDegrees * crown_pig.getAngle();
        batch.draw(crownpig, (v.x)*ppm -15, (v.y)*ppm - 15, 15, 15, 30, 30, 1, 1, angle);
        angle = MathUtils.radiansToDegrees * crown_pig2.getAngle();
        batch.draw(crownpig, (v2.x)*ppm -15, (v2.y)*ppm - 15, 15, 15, 30, 30, 1, 1, angle);
        angle = MathUtils.radiansToDegrees * crown_pig3.getAngle();
        batch.draw(crownpig, (v3.x)*ppm -15, (v3.y)*ppm - 15, 15, 15, 30, 30, 1, 1, angle);
