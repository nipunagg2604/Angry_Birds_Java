...
public class Level3Screen implements Screen, InputProcessor {
    ...
    private ArrayList<Body> stone_squares;
    ...
    public Level3Screen(final Core game,int themeindex, boolean flag, String filename){
        ...
        glass_vertical=new TextureRegion(new Texture("Blocks/Glass Blocks/glass_block_type_2.png"));
        glass_horizontal=new TextureRegion(new Texture("Blocks/Glass Blocks/glass_horizontal.png"));
        wooden_square = new TextureRegion(new Texture("Blocks/Wooden Blocks/wooden_square.png"));
        wooden_thick = new TextureRegion(new Texture("Blocks/Wooden Blocks/wooden_thick.png"));
        stone_square = new TextureRegion(new Texture("Blocks/Stone Blocks/stone_square.png"));
...
//        }
    ...
    public void loadData()
    {
        try {
            ...
            for(int i=0; i<9; i++) {
                ...
                else if(i == 6) stone_squares = arr;
                else if(i == 7) soils = arr;
                else thick_hor = arr;
            }
    ...
    public boolean touchDown(int screenX, int screenY, int pointer, int button) {
        ...
        for (Body i: stone_squares) {
            for (Fixture f:i.getFixtureList()) {
                if (f.testPoint(worldcoor.x, worldcoor.y)) {
                    world.destroyBody(i);
                    stone_squares.remove(i);
                    return true;
                }
            }
        }
