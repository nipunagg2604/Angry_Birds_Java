...
public class Level2Screen implements Screen, InputProcessor {
    ...
    private ArrayList<Body> wooden_verticals;
    private ArrayList<Body> wooden_horizontals;
    private ArrayList<Body> wooden_squares;
    private ArrayList<Body> thick_hor;
    private ArrayList<Body> glass_verticals;
    private ArrayList<Body> glass_horizontals;
    private ArrayList<Body> stone_verticals;
    private ArrayList<Body> stone_horizontals;
    private ArrayList<Body> thick_ver;

    private TextureRegion wooden_ver;
    private TextureRegion wooden_hor;
    private TextureRegion stone_ver;
    private TextureRegion stone_hor;
    private TextureRegion glass_hor;
    private TextureRegion glass_ver;
    private TextureRegion wooden_square;
    private TextureRegion wooden_thick_hor;
    private TextureRegion wooden_thick_ver;
    ...
    public Level2Screen(final Core game, int themeindex, boolean flag, String filename){
        ...
        glass_ver=new TextureRegion(new Texture("Blocks/Glass Blocks/glass_block_type_2.png"));
        glass_hor=new TextureRegion(new Texture("Blocks/Glass Blocks/glass_horizontal.png"));
        wooden_square = new TextureRegion(new Texture("Blocks/Wooden Blocks/wooden_square.png"));
        wooden_thick_hor = new TextureRegion(new Texture("Blocks/Wooden Blocks/wooden_thick.png"));
        wooden_thick_ver = new TextureRegion(new Texture("Blocks/Wooden Blocks/wooden_thick_vertical.png"));
        stone_ver = new TextureRegion(new Texture("Blocks/Stone Blocks/stone_thick_vertical.png"));
        stone_hor = new TextureRegion(new Texture("Blocks/Stone Blocks/stone_thick_horizontal.png"));
        ...
        if(flag) {
            wooden_verticals=new Structures("wooden_vertical",world, 1000, 0, 0.2f,0.2f, filename).return_array();
            wooden_horizontals=new Structures("wooden_horizontal",world, 6, 0, 0.2f, 0.2f, filename).return_array();;
            wooden_squares=new Structures("wooden_square",world, 1000, 0,0.2f, 0.2f, filename).return_array();;
            thick_hor=new Structures("wooden_thick_horizontal",world, 1000, 0,0.2f, 0.2f, filename).return_array();;
            glass_verticals=new Structures("glass_vertical",world, 1000, 0,0.2f, 0.2f, filename).return_array();;
            glass_horizontals=new Structures("glass_horizontal",world, 1000, 0,0.2f, 0.2f, filename).return_array();;
            stone_verticals=new Structures("stone_thick_vertical",world, 1000, 0,0.2f, 0.2f, filename).return_array();;
            stone_horizontals=new Structures("stone_thick_horizontal",world, 1000, 0,0.2f, 0.2f, filename).return_array();;
            thick_ver=new Structures("wooden_thick_vertical",world, 1000, 0,0.2f, 0.2f, filename).return_array();;
            ...
            crown_pig=(new Crown_Pig(world,5f,0f)).addpig(world,624,289,15);
            crown_pig2=(new Crown_Pig(world,5f,0f)).addpig(world,727,189,15);
            crown_pig3=(new Crown_Pig(world,5f,0f)).addpig(world,831,292,15);
            pigbodies.add(crown_pig2);
            pigbodies.add(crown_pig3);
...
//                    // Limit the drag distance (optional)
        ...
        button.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                ...
                pauseScreen= new io.github.angrybirdsjava.PauseScreen(game,Level2Screen.this,inputMultiplexer, filename);
                ispause=true;
    ...
    public void render(float delta) {
        ...
        for (Body b:stone_verticals){
            ...
            if (((String)(a.get(2))).equals("flag") && ((String)(a.get(1))).equals("false")){
                ...
                b.getFixtureList().get(0).setUserData(a);
                thistotal+=800;
                ShowMessage show=new ShowMessage("stone","800",b.getPosition().cpy().scl(ppm).x,b.getPosition().cpy().scl(ppm).y,2f);
                showmessages.add(show);
            }
        }
        for (Body b:stone_horizontals){
        ...
        for (Body rectangle : wooden_horizontals) {
        ...
        for (Body rectangle : wooden_verticals) {
            String s=(String) (((ArrayList)(rectangle.getFixtureList().get(0).getUserData())).get(1));
            if (s.equals("false")) {continue;}
            ArrayList<Float> a = new ArrayList();
            float angle = MathUtils.radiansToDegrees * rectangle.getAngle();
        ...
        for (Body rectangle : glass_horizontals) {
            ...
            Vector2 v = new Vector2();
            v = (Vector2) rectangle.getPosition();
            batch.draw(glass_hor, v.x*ppm - a.get(2), v.y*ppm - a.get(3), a.get(2), a.get(3), 2 * a.get(2), 2 * a.get(3), 1, 1, angle);
        }
        for (Body rectangle : glass_verticals) {
            ...
            Vector2 v = new Vector2();
            v = (Vector2) rectangle.getPosition();
            batch.draw(glass_ver, v.x*ppm - a.get(2), v.y*ppm - a.get(3), a.get(2), a.get(3), 2 * a.get(2), 2 * a.get(3), 1, 1, angle);
        }
        ...
        for (Body rectangle : thick_hor) {
            ...
            Vector2 v = new Vector2();
            v = (Vector2) rectangle.getPosition();
            batch.draw(wooden_thick_hor, v.x*ppm - a.get(2), v.y*ppm - a.get(3), a.get(2), a.get(3), 2 * a.get(2), 2 * a.get(3), 1, 1, angle);
        }
        for (Body rectangle : thick_ver) {
            String s=(String) (((ArrayList)(rectangle.getFixtureList().get(0).getUserData())).get(1));
            if (s.equals("false")) {continue;}
            ArrayList<Float> a = new ArrayList();
            float angle = MathUtils.radiansToDegrees * rectangle.getAngle();
            ...
            Vector2 v = new Vector2();
            v = (Vector2) rectangle.getPosition();
            batch.draw(wooden_thick_ver, v.x*ppm - a.get(2), v.y*ppm - a.get(3), a.get(2), a.get(3), 2 * a.get(2), 2 * a.get(3), 1, 1, angle);
        }
        for (Body rectangle : stone_horizontals) {
            String s=(String) (((ArrayList)(rectangle.getFixtureList().get(0).getUserData())).get(1));
            if (s.equals("false")) {continue;}
            ArrayList<Float> a = new ArrayList();
            float angle = MathUtils.radiansToDegrees * rectangle.getAngle();
            ...
            Vector2 v = new Vector2();
            v = (Vector2) rectangle.getPosition();
            batch.draw(stone_hor, v.x*ppm - a.get(2), v.y*ppm - a.get(3), a.get(2), a.get(3), 2 * a.get(2), 2 * a.get(3), 1, 1, angle);
        }
        for (Body rectangle : stone_verticals) {
            String s=(String) (((ArrayList)(rectangle.getFixtureList().get(0).getUserData())).get(1));
            if (s.equals("false")) {continue;}
            ArrayList<Float> a = new ArrayList();
            float angle = MathUtils.radiansToDegrees * rectangle.getAngle();
...
//        }
    ...
    public void saveData()
    {
        try {
            ...
            if(themeindex == 0) fout = new FileOutputStream("data02.txt");
            else if(themeindex == 1) fout = new FileOutputStream("data12.txt");
            else fout = new FileOutputStream("data22.txt");
            ObjectOutputStream oout = new ObjectOutputStream(fout);

            ArrayList<ArrayList<Body>> arr = new ArrayList<>();
            arr.add(wooden_horizontals);
            arr.add(wooden_verticals);
            arr.add(stone_horizontals);
            arr.add(glass_verticals);
            arr.add(glass_horizontals);
            arr.add(wooden_squares);
            arr.add(thick_ver);
            arr.add(thick_hor);
            arr.add(stone_verticals);
            ...
            Crown_Pig pig = ((Crown_Pig) ((ArrayList) crown_pig.getFixtureList().get(0).getUserData()).get(0));
            Crown_Pig pig2 = ((Crown_Pig) ((ArrayList) crown_pig2.getFixtureList().get(0).getUserData()).get(0));
            Crown_Pig pig3 = ((Crown_Pig) ((ArrayList) crown_pig3.getFixtureList().get(0).getUserData()).get(0));
            oout.writeObject(pig.damage);
            oout.writeObject(pig.strength);
            oout.writeObject(pig2.damage);
            oout.writeObject(pig2.strength);
            oout.writeObject(pig3.damage);
            oout.writeObject(pig3.strength);
            arr2.add(crown_pig);
            arr2.add(crown_pig2);
            arr2.add(crown_pig3);
            ...
            for (Body b : arr2) {
                ...
                oout.writeObject(b.isFixedRotation());
                oout.writeObject(b.isBullet());
                if(check != 0 && check != 1 && check != 2) oout.writeObject(b.getUserData());
                oout.writeObject(b.getFixtureList().get(0).getUserData());
                check++;
            }
    ...
    public void loadData()
    {
        try {
            FileInputStream fin;
            if(themeindex == 0) fin = new FileInputStream("data02.txt");
            else if(themeindex == 1) fin = new FileInputStream("data12.txt");
            else fin = new FileInputStream("data22.txt");
            ...
            for(int i=0; i<9; i++) {
                ...
                if(i == 0) wooden_horizontals = arr;
                else if(i == 1) wooden_verticals = arr;
                else if(i == 2) stone_horizontals = arr;
                else if(i == 3) glass_verticals = arr;
                else if(i == 4) glass_horizontals = arr;
                else if(i == 5) wooden_squares = arr;
                else if(i == 6) thick_ver = arr;
                else if(i == 7) thick_hor = arr;
                else stone_verticals = arr;
            }


            float crownPigDamage = ((float) oin.readObject());
            float crownPigStrength = ((float) oin.readObject());
            float crownPigDamage2 = ((float) oin.readObject());
            float crownPigStrength2 = ((float) oin.readObject());
            ...
            for(int i=0; i<6; i++) {
                ...
                if(i!=0 && i!=1 && i!=2) userData = ((Object) oin.readObject());
                Object userData2 = ((Object) oin.readObject());

                if(i==0) {
                    crown_pig = (new Crown_Pig(world, crownPigStrength, crownPigDamage)).addPig(world, posX, posY, velX, velY, ang, angle, type, grvScl, radius, density, friction, restitution, categoryBits, maskBits, groupIndex, isAwake, isSlAl, isFxdRotation, isBullet, userData2);
                    pigbodies.add(crown_pig);
                }else if(i == 1) {
                    crown_pig2 = (new Crown_Pig(world, crownPigStrength2, crownPigDamage2)).addPig(world, posX, posY, velX, velY, ang, angle, type, grvScl, radius, density, friction, restitution, categoryBits, maskBits, groupIndex, isAwake, isSlAl, isFxdRotation, isBullet, userData2);
                    pigbodies.add(crown_pig2);
                }else if(i == 2) {
                    crown_pig3 = (new Crown_Pig(world, crownPigStrength3, crownPigDamage3)).addPig(world, posX, posY, velX, velY, ang, angle, type, grvScl, radius, density, friction, restitution, categoryBits, maskBits, groupIndex, isAwake, isSlAl, isFxdRotation, isBullet, userData2);
                    pigbodies.add(crown_pig3);
                }
    ...
    public boolean touchDown(int screenX, int screenY, int pointer, int button) {
        ...
        for (Body i: wooden_verticals) {
            for (Fixture f:i.getFixtureList()) {
                if (f.testPoint(worldcoor.x, worldcoor.y)) {
                    world.destroyBody(i);
                    wooden_verticals.remove(i);
                    return true;
                }
            }
        }
        for (Body i: wooden_horizontals) {
            for (Fixture f:i.getFixtureList()) {
                if (f.testPoint(worldcoor.x, worldcoor.y)) {
                    world.destroyBody(i);
                    wooden_horizontals.remove(i);
                    return true;
                }
            }
        }
        for (Body i: wooden_squares) {
            for (Fixture f:i.getFixtureList()) {
                if (f.testPoint(worldcoor.x, worldcoor.y)) {
                    world.destroyBody(i);
                    wooden_squares.remove(i);
                    return true;
                }
            }
        }
        for (Body i: glass_verticals) {
            for (Fixture f:i.getFixtureList()) {
                if (f.testPoint(worldcoor.x, worldcoor.y)) {
                    world.destroyBody(i);
                    glass_verticals.remove(i);
                    return true;
                }
            }
        }
        for (Body i: glass_horizontals) {
            for (Fixture f:i.getFixtureList()) {
                if (f.testPoint(worldcoor.x, worldcoor.y)) {
                    world.destroyBody(i);
                    glass_horizontals.remove(i);
                    return true;
                }
            }
        }
        for (Body i: thick_hor) {
            for (Fixture f:i.getFixtureList()) {
                if (f.testPoint(worldcoor.x, worldcoor.y)) {
                    world.destroyBody(i);
                    thick_hor.remove(i);
        ...
        for (Body i: stone_horizontals) {
            for (Fixture f:i.getFixtureList()) {
                if (f.testPoint(worldcoor.x, worldcoor.y)) {
                    world.destroyBody(i);
                    stone_horizontals.remove(i);
                    return true;
                }
            }
        }
        for (Body i: stone_verticals) {
            for (Fixture f:i.getFixtureList()) {
                if (f.testPoint(worldcoor.x, worldcoor.y)) {
                    world.destroyBody(i);
                    stone_verticals.remove(i);
                    return true;
                }
            }
        }
