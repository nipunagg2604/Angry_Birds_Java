...
public class Level2Screen implements Screen, InputProcessor {
    ...
    private ArrayList<Body> rectangles_ver=new Structures("stone_vertical",world, 1000, 0, "Level_tmx_files/level-2.tmx").return_array();
    private ArrayList<Body> rectangles_hor=new Structures("wooden_horizontal",world, 6, 0, "Level_tmx_files/level-2.tmx").return_array();;
    private ArrayList<Body> soils=new Structures("soil",world, 1000, 0, "Level_tmx_files/level-2.tmx").return_array();;
    private ArrayList<Body> trisoils=new Structures("trisoil",world, 1000, 0, "Level_tmx_files/level-2.tmx").return_array();;
...
//                particleEffectsmoke.dispose();
        ...
        tiledMap = mapLoader.load("Level_tmx_files/level-2.tmx");
        ...
        button.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                ...
                game.setScreen(new io.github.angrybirdsjava.PauseScreen(game, io.github.angrybirdsjava.Level2Screen.this, getStage()));
            }
        });
...
//            }
            ...
            //shapeRenderer.polygon(transformedVertices); // Draw the polygon (triangle)
            //shapeRenderer.end();
        }
